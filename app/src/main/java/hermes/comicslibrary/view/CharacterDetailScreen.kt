...
fun CharacterDetailScreen(
    ...
    LaunchedEffect(key1 = Unit) {
        //to call suspended functions safely from inside a Composable. When launched effect enters
        //the composition, it launches a coroutine with the block of code passed as a parameter.
